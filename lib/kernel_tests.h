...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    QA(VOLK_INIT_TEST(volk_32fc_s32f_atan2_32f,                       test_params_inacc))
    QA(VOLK_INIT_TEST(volk_32fc_x2_conjugate_dot_prod_32fc,           test_params_inacc_tenth))
    QA(VOLK_INIT_TEST(volk_32fc_add_real_imag_32f,                    test_params))
    ...
    QA(VOLK_INIT_TEST(volk_32f_s32f_power_32f,                        test_params_inacc))
    ...
    QA(VOLK_INIT_TEST(volk_32i_convert_32f,                           test_params))
    QA(VOLK_INIT_TEST(volk_32f_convert_32i,                           test_params))
